...
public class main {
	...
	public static void Main(String[] args) {
		...
		int clasePizza=1;
		while(clasePizza<=3) {
			System.out.println("Ingrese diametro de pizza (entre 20, 30 o 40): ");
			...
			while (!scanner.hasNextBoolean()) {
				System.out.println("Error solo puede ingresar true por si, o false por no. Vuelva a intentarlo:");
				scanner.next();
			}
			...
			System.out.println("Precio de la pizza: "+pizza.CalcularPrecio());
